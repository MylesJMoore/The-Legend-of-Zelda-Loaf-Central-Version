...
if (obj_input.shoot_key)
{
    ...
    audio_play_sound(snd_projectile, 6, false);
    var xforce = lengthdir_x(5, face*90);       //Controls Speed of Projectiles
    var yforce = lengthdir_y(5, face*90);       //Controls Speed of Projectiles
    p.creator = id;
    with (p)
    {
